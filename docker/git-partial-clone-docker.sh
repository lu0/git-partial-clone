...
_show_usage() {
    ...
    echo -e "                      -v /path/to/token/file ..."
    echo -e "\nExample:"
    echo -e "   source ${PWD}/test/${WRAPPER_SCRIPT}.conf"
    echo -e "   docker run --env-file ${PWD}/test/${WRAPPER_SCRIPT}.conf ..."
    echo -e "                      -v ${PWD}/test/.github-token:${TOKEN_PATH} ..."
    echo -e "\nMandatory variables:"
